...
(function () {
  ...
  .defaultButton {
      ...
      background-image: -webkit-linear-gradient(top, rgba(255,255,255,.8) 0%, rgba(255,255,255,0) 100%);
      color : rgb(19, 19, 19);
  ...
  TextBox.prototype.getTextBoxId = function () {
    "use strict";
    var query = `div#${RS.InputDialog.Params.szFieldId} table.inputDialogContainer tr td textarea[class=inputDialog]`;
  ...
  TextBox.prototype.setRect = function () {
    ...
    if(OkButton){
      ...
      OkButton.style.height = (BirthdayManager.messH()*Graphics._realScale-padding*2)*0.20+"px";
    }
  ...
  TextBox.prototype.hide = function () {
    ...
    //$(this._fieldId).fadeOut("fast");
    $("#"+this._fieldId).fadeOut();
  };

  TextBox.prototype.show = function () {
    var field = document.getElementById(this._fieldId);
    //var t = this.getTextBoxId();
    //t.style.display = "none";
    field.style.zIndex = 1000;
    //$(".md_textBox").fadeIn("fast");
    //field.style.display = "block"; // for 0.33.4 

    //var container = this.getMainContainer();
    //container.style.display = "none";
    $("#"+this._fieldId).fadeIn();
    //$(this._fieldId).fadeIn("fast");
  };
...
//});
  ...
  Scene_InputDialog.prototype.createBackground = function() {
    if(Imported.Irina_PerformanceUpgrade) {
      ...
      //var letter = new Image_letter();
      //this._backgroundSprite.addChild(letter);
    }
  };
