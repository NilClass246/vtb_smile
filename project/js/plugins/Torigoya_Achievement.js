...
(function (global) {
    ...
    BirthdayManager.changeAchievements = function(list){
        AchievementManager._achievements = list;
    }

    BirthdayManager.getAchievements = function(){
        return AchievementManager._achievements;
    }

    BirthdayManager.achievementSave = function(){
