...
Window.prototype.initialize = function() {
    ...
    this._downArrowBitmap = ImageManager.loadPicture("arrow/downArrow");
    this._upArrowBitmap = ImageManager.loadPicture("arrow/upArrow");
...
Window.prototype._createAllParts = function() {
    ...
    this._downArrowSprite = new Sprite_BirthdayArrow(this._downArrowBitmap, "down");
    this._upArrowSprite = new Sprite_BirthdayArrow(this._upArrowBitmap, "up");
    this._windowPauseSignSprite = new Sprite();
    this._windowBackSprite.bitmap = new Bitmap(1, 1);
    this._windowBackSprite.alpha = 255 / 255;
...
Window.prototype._refreshArrows = function() {
    ...
    this._downArrowSprite.anchor.x = 0.5;
    this._downArrowSprite.anchor.y = 0.5;
    this._downArrowSprite.scale.x = 2.2;
    this._downArrowSprite.scale.y = 2.2;
    this._downArrowSprite.move(w/2, h-q);
    this._upArrowSprite.anchor.x = 0.5;
    this._upArrowSprite.anchor.y = 0.5;
    this._upArrowSprite.scale.x = 2.2;
    this._upArrowSprite.scale.y = 2.2;
    this._upArrowSprite.move(w/2, q);
};
